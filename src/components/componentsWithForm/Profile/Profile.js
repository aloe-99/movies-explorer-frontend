  ...
  return (
    <form className='form form_profile'>
      ...
      <fieldset className='form__buttons'>
        <button className='form__text_color_light form__text-btn link-dissolution' type='submit'>Редактировать</button>
        <Link className='form__text_color_red form__text-btn link-dissolution'>Выйти из аккаунта</Link>
      </fieldset>
    </form>
  );
}
