...
function SavedMovies(props) {
  ...
  const [savedReqText, setSavedReqText] = useState('');
  const [savedReqCheckbox, setSavedReqCheckbox] = useState(false);
  ...
  return (
    <>
      <SearchForm onSubmit={sortMovies} location={location.pathname} setSavedReqText={setSavedReqText} setSavedReqCheckbox={setSavedReqCheckbox} />
      {resultBlock}
    </>
  );
}
